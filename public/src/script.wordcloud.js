...
function startCloud(sourceText,divid) {
    const container = document.getElementById(divid);
    const width = container.clientWidth;
    const height = container.clientHeight;

    console.log("startCloud")
    if (!container) return;
    console.log("!container")
    const preprocessedWords = preprocessText(sourceText);
    console.log("preprocessText")
    const wordCloudSVG = WordCloud(preprocessedWords,width,height);
    console.log("wordCloudSVG")
    document.getElementById(divid).appendChild(wordCloudSVG);
    console.log("startprocess end")
}
...
function WordCloud(text,width,height) {
    var size = group => group.length,
